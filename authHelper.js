    ...
    try {
        ...
        try {
            ...
            if (timeoutError.message.includes('timeout')) {
                console.logDebug('Authentication timeout - user not authenticated');
...
async function requireAuthentication() {
    ...
    if (!userId) {
        ...
        if (window.location.pathname !== '/index.html' && window.location.pathname !== '/') {
            console.logInfo('User not authenticated, redirecting to login');
...
function redirectToLogin() {
    console.logInfo('Redirecting to login page');
    if (window.location.pathname !== '/index.html' && window.location.pathname !== '/') {
        window.location.href = '/index.html';
    }
}
...
console.logInfo('✅ Simplified Auth Helper loaded (invite-only system)');